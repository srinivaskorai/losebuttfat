...
<html lang="en-US">
	...
	<title>Log In &lsaquo; How to Lose Butt Fat &#8212; WordPress</title>
	<meta name="robots" content="max-image-preview:large, noindex, noarchive">
<link rel="stylesheet" id="superb-blocks-fontawesome-css-css" href="./wp-content/plugins/superb-blocks/lib/fontawesome/css/all.min.css?ver=2.0.3" type="text/css" media="all">
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.1.1" type="text/css" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://bootyblast.test/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://bootyblast.test/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to How to Lose Butt Fat</a>		</p>
			</div>
...
var userProfileL10n = {"user_id":"0","nonce":"8d266d5af4"};
/*  */</script>
